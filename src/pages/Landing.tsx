          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-5 sm:space-y-6">
              ...
              <div className="space-y-2 max-w-md">
                ...
                <p className="text-base sm:text-lg text-[#5f7a60] leading-relaxed">
                  ...
                  while championing quality and innovation.
                </p>
              </div>
              <div className="flex flex-wrap gap-3 pt-2">
                ...
                <a
                  href="#about"
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-[#2e7d32] glass-panel hover:shadow-lg transition-all text-sm border border-[rgba(46,125,50,0.2)] cursor-pointer"
                >
                  Learn More
                </a>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-5 -left-4 z-20 glass-panel px-4 py-3 flex items-center gap-3">
                ...
                <div>
                  <p
                    className="font-bold text-[#1a3d1f] text-sm"
                    style={{ fontFamily: "Outfit,sans-serif" }}
                  >
                    Circular Economy
                  </p>
              ...
              <div className="absolute -top-4 -right-4 z-20 glass-panel px-4 py-3">
                <div className="flex items-center gap-2">
                  ...
                  <p
                    className="font-black text-[#1a3d1f] text-sm"
                    style={{ fontFamily: "Outfit,sans-serif" }}
                  >
                    Earn Points
                  </p>
            ...
            {[
              {
                ...
                desc: "Drop your plastic waste into designated recycling bins.",
              },
              {
                icon: <Leaf className="w-7 h-7 text-[#2e7d32]" />,
                step: "02",
                title: "Snap & Upload",
                desc: "Take a clear photo showing the deposit and upload it to our platform.",
              },
              {
                icon: <Star className="w-7 h-7 text-[#ffb300]" />,
                step: "03",
              ...
              <div key={step} className="glass-card p-6 sm:p-8 cursor-default">
                <div className="flex items-start gap-4 mb-5">
                  ...
                  <span
                    className="text-4xl font-black text-[rgba(46,125,50,0.12)]"
                    style={{ fontFamily: "Outfit,sans-serif" }}
                  >
                    {step}
                  </span>
                </div>
                <h3 className="text-xl font-bold text-[#1a3d1f] mb-2">
                  {title}
                </h3>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-8 sm:mb-10 gap-4">
            ...
            <Link
              to="/events"
              className="hidden sm:flex items-center gap-2 text-sm font-bold text-[#2e7d32] hover:underline cursor-pointer"
            >
          ...
          {events.length === 0 ? (
            <div className="glass-panel p-6 sm:p-8 lg:p-12 text-center">
              ...
              <p className="text-xs text-[#5f7a60] mt-1 opacity-70">
                Check back soon — the admin will post events here.
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {events.map((event: any) => (
                <div
                  key={event.id}
                  className="glass-card overflow-hidden flex flex-col sm:flex-row cursor-default"
                >
                  <img
                    src={
                      event.poster_url ||
                  ...
                  <div className="p-6 flex flex-col justify-between">
                    <div>
                      <h3 className="font-bold text-xl text-[#1a3d1f] mb-2">
                        {event.title}
                      </h3>
                      <p className="text-[#5f7a60] text-sm mb-4 leading-relaxed line-clamp-2">
                        {event.description}
                      </p>
                    </div>
                    <div className="flex flex-col gap-2">
                      ...
                      {event.location && (
                        <span className="text-xs text-[#5f7a60] pl-1">
                          {event.location}
                        </span>
                      )}
                    </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {products.length === 0 ? (
            <div className="glass-panel p-6 sm:p-8 lg:p-12 text-center">
              ...
              <p className="text-xs text-[#5f7a60] mt-1 opacity-70">
                Admin needs to add products via the dashboard.
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.map((product) => (
                ...
                >
                  ...
                  />
                  <div className="p-5">
                    <h3 className="font-bold text-lg text-[#1a3d1f] mb-1">
                      {product.name}
                    </h3>
                    <p className="text-[#5f7a60] text-sm mb-4 line-clamp-2">
                      {product.description}
                    </p>
                    <div className="flex justify-between items-center">
                      <span className="font-black text-[#2e7d32] text-lg">
          ...
          <div className="glass-panel-dark p-6 sm:p-8 lg:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[rgba(200,230,201,0.9)] mb-8 max-w-lg mx-auto">
                Join thousands of eco-warriors earning rewards while cleaning up
                our planet. Every action counts.
              </p>
              <Link
                to="/signup"
