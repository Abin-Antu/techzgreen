...
const INITIAL_PRODUCTS: Product[] = [
  { id: '1', name: 'Recycled Plastic Planter Box', description: 'A durable and colorful planter box made entirely from upcycled plastic waste with eco-friendly rope handles. Perfect for indoor or patio plants.', price: 25, image_url: '/planter.jpg', stock: 10 },
  { id: '2', name: 'Eco-Friendly Reusable Bag', description: 'A durable bag made from 100% recycled plastic.', price: 15, image_url: 'https://images.unsplash.com/photo-1597349666014-41d92790d984?auto=format&fit=crop&q=80&w=400', stock: 20 },
  { id: '3', name: 'Bamboo Toothbrush Set', description: 'Sustainable bamboo toothbrushes, a perfect alternative to plastic.', price: 8, image_url: 'https://images.unsplash.com/photo-1605600659929-e85df649f87c?auto=format&fit=crop&q=80&w=400', stock: 30 },
  { id: '4', name: 'Recycled Glass Water Bottle', description: 'Stay hydrated with a premium recycled glass bottle.', price: 20, image_url: 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?auto=format&fit=crop&q=80&w=400', stock: 15 }
];
