...
const INITIAL_PRODUCTS: Product[] = [
  { id: '1', name: 'Recycled Plastic Planter Box', description: 'A durable and colorful planter box made entirely from upcycled plastic waste with eco-friendly rope handles. Perfect for indoor or patio plants.', pointCost: 250, imageUrl: '/planter.jpg' },
  { id: '2', name: 'Eco-Friendly Reusable Bag', description: 'A durable bag made from 100% recycled plastic.', pointCost: 50, imageUrl: 'https://images.unsplash.com/photo-1597349666014-41d92790d984?auto=format&fit=crop&q=80&w=400' },
  { id: '3', name: 'Bamboo Toothbrush Set', description: 'Sustainable bamboo toothbrushes, a perfect alternative to plastic.', pointCost: 100, imageUrl: 'https://images.unsplash.com/photo-1605600659929-e85df649f87c?auto=format&fit=crop&q=80&w=400' },
  { id: '4', name: 'Recycled Glass Water Bottle', description: 'Stay hydrated with a premium recycled glass bottle.', pointCost: 150, imageUrl: 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?auto=format&fit=crop&q=80&w=400' }
];
